    ...
    public boolean[][] PossibleMoves() {
        ...
        if (getColor() == Color.white) {
            ...
            if (position.getRow() == 3) {
                ...
                if (getBoard().positionExits(left) && IsOpponentPiece(left) && getBoard().piece(left) == chessMatch.getEnPassantVulnerable()) {
                    mat[left.getRow() - 1][left.getColumn()] = true;
                }
                Position right = new Position(position.getRow(), position.getColumn() + 1);
                if (getBoard().positionExits(right) && IsOpponentPiece(right) && getBoard().piece(right) == chessMatch.getEnPassantVulnerable()) {
